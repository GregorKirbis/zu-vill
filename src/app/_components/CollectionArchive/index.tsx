...
export const CollectionArchive: React.FC<Props> = (props) => {
  const { categories: catsFromProps, className, limit = 10, onResultChange, populateBy, populatedDocs, populatedDocsTotal, relationTo, selectedDocs, showPageRange, sort = "-createdAt" } = props;
        ...
        {showPageRange !== false && populateBy !== "selection" && (
          <Gutter>
            <div className={classes.pageRange}>
              <PageRange collection={relationTo} currentPage={results.page} limit={limit} totalDocs={results.totalDocs} />
            </div>
          </Gutter>
        )}
        <Gutter>
          ...
          {results.totalPages > 1 && populateBy !== "selection" && <Pagination className={classes.pagination} onClick={setPage} page={results.page} totalPages={results.totalPages} />}
        </Gutter>
      </Fragment>
    </div>
  );
