    ...
    <Fragment>
      <Gutter className={classes.projectHero}>
        <div className={classes.content}>
          ...
          <div>
            <p className={classes.description}>
              ...
              <Link href={`${process.env.NEXT_PUBLIC_SERVER_URL}/admin/collections/projects/${id}`}>navigate to the admin dashboard</Link>
              {"."}
            </p>
          </div>
        </div>
        <div className={classes.media}>
          ...
          {metaImage && typeof metaImage !== "string" && metaImage?.caption && <RichText content={metaImage.caption} className={classes.caption} />}
        </div>
      </Gutter>
    </Fragment>
  );
