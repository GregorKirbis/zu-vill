    ...
    <form onSubmit={handleSubmit(onSubmit)} className={classes.form}>
      ...
      {!changePassword ? (
        ...
        <Fragment>
          ...
          <Input name="passwordConfirm" type="password" label="Confirm Password" required register={register} validate={(value) => value === password.current || "The passwords do not match"} error={errors.passwordConfirm} />
        </Fragment>
      )}
      <Button type="submit" label={isLoading ? "Processing" : changePassword ? "Change Password" : "Update Account"} disabled={isLoading} appearance="primary" className={classes.submit} />
    </form>
  );
};
